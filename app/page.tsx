          ...
          <div className="form-area">
            ...
            {step === 1 && (
              <div className="step-content">
                ...
                {editingStage&&questPlan.find(s=>s.id===editingStage)?.type==="secret"&&<div className="secret-builder"><b>ตั้งรหัสลับสำหรับด่านนี้</b><p>ผู้เล่นต้องพิมพ์ตรงกันจึงจะผ่านด่าน</p><input placeholder="เช่น วันที่เจอกันครั้งแรก หรือคำที่รู้กันสองคน" value={questPlan.find(s=>s.id===editingStage)?.answer||""} maxLength={20} onChange={e=>updateStage(editingStage,{answer:e.target.value})}/></div>}
